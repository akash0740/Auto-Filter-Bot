...
# Bot information
API_ID = environ.get('API_ID', '20315231')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '2020973918')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001997033812').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002006846279').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002064829273')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002089518882')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Cluster0:D9QUEgzUlg19BFxh@cluster0.5dzvhrt.mongodb.net/?retryWrites=true&w=majority")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002006846279")
